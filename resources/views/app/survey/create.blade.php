        ...
        <div class="p-6">
                    ...
                    <table class="matrix-table">
                        ...
                        <tbody id="rt-table-body">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-input" style="min-width:160px" /></td>
                                <td>
                                    <select class="form-input" style="min-width:120px">
                                        <option value="">-</option>
                                        <option>Laki-laki</option>
                                        <option>Perempuan</option>
                                    </select>
                                </td>
                                <td><input type="number" class="form-input" style="width:70px" min="60" /></td>
                                <td><input type="text" class="form-input" style="min-width:120px" placeholder="Hub. keluarga" /></td>
                            </tr>
                            @endfor
                        </tbody>
                    </table>
                    ...
                    <table class="matrix-table">
                        ...
                        <tbody id="e6-table-body">
                            ...
                            <tr>
                                <td class="text-center">{{ $i }}</td>
                                <td><input type="text" class="form-input" style="min-width:140px" /></td>
                                @foreach(['e_ktp', 'ktp_nas', 'no_ktp'] as $ktp)
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="radio-group mt-1">
                            ...
                            <label class="radio-opt"><input type="radio" name="kunjungi"> {{ $opt }}</label>
                            @endforeach
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="radio-group mt-1">
                            <label class="radio-opt"><input type="radio" name="perkumpulan"> Ya</label>
                            <label class="radio-opt"><input type="radio" name="perkumpulan"> Tidak</label>
                        </div>
                    </div>
                    <div>
                        <label class="form-label">K44. Terlibat pertemuan warga?</label>
                        <div class="radio-group mt-1">
                            <label class="radio-opt"><input type="radio" name="rapat_warga"> Pernah</label>
                            <label class="radio-opt"><input type="radio" name="rapat_warga"> Tidak</label>
                        </div>
                    </div>
                    <div>
                        <label class="form-label">K45. Partisipasi pemilu?</label>
                        <div class="radio-group mt-1">
                            <label class="radio-opt"><input type="radio" name="pemilu"> Pernah</label>
                            <label class="radio-opt"><input type="radio" name="pemilu"> Tidak</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section" id="section-8">
                ...
                <div>
                    ...
                    <textarea class="form-input" rows="3" placeholder="Catatan tambahan dari surveyor..."></textarea>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('sel-city')?.addEventListener('change', function() {
        ...
        if (!this.value) { districtSel.innerHTML = '<option value="">-- Pilih Distrik --</option>'; districtSel.disabled = true; return; }
    ...
    document.getElementById('sel-district')?.addEventListener('change', function() {
        const villageSel = document.getElementById('sel-village');
        if (!this.value) { villageSel.innerHTML = '<option value="">-- Pilih Kelurahan --</option>'; villageSel.disabled = true; return; }
    ...
    document.getElementById('btn-add-b2')?.addEventListener('click', function() {
        ...
        tr.innerHTML = `
            ...
            <td><input type="text" class="form-input" style="min-width:160px" /></td>
            <td><select class="form-input" style="min-width:120px"><option value="">-</option><option>Laki-laki</option><option>Perempuan</option></select></td>
            <td><input type="number" class="form-input" style="width:70px" min="60" /></td>
            <td><input type="text" class="form-input" style="min-width:120px" placeholder="Hub. keluarga" /></td>
        `;
    ...
    document.getElementById('btn-add-e6')?.addEventListener('click', function() {
        ...
        tr.innerHTML = `
            ...
            <td><input type="text" class="form-input" style="min-width:140px" /></td>
            ${['e_ktp','ktp_nas','no_ktp'].map(v => `<td><input type="radio" name="ktp_${rowCountE6}" value="${v}" /></td>`).join('')}
        `;
        tbody.appendChild(tr);
    });

    // Auto-calculate total pengeluaran
    const pengeluaranInputs = document.querySelectorAll('input[name^="pengeluaran_"][name!="pengeluaran_total"]');
